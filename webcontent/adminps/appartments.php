  ...
  <div class="container">
  	<div class="col-md-12">
  		<form class="house-form" action="insert.php" method="post" enctype="multipart/form-data">
		    ...
		    <input type="text" name="ptype" class="form-control" placeholder="Appartment" value="Appartment" readonly>
		    <br>
		    <label>Images</label>
		    <input type="file" name="housepic" class="form-control">
		    <br><br>
		    ...
		    <input type="text" name="hbathrooms" class="form-control">
		    <label>Bedrooms</label>
		    <input type="text" name="hrooms" class="form-control">
		    <div class="form-group">
                    <label>Kitchen</label>
		    ...
		    <button class="btn btn-dark" name="addappart">Submit Listing</button>

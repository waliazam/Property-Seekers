  ...
  <div class="container">
  	<div class="col-md-12">
  		<form class="house-form" action="insert.php" method="post" enctype="multipart/form-data">
		    ...
		    <input type="text" id="disabledInput" name="plottype" value="Commercial Plot" class="form-control" placeholder="Plot" readonly>
		    <br>
        ...
        <label>Plot Number</label>
		    <input type="text" name="plotno" class="form-control" maxlength="6" placeholder="Max 6 Charectors">
        <label>Street</label>
		    <input type="text" name="plotstreet" class="form-control">
        <label>Block</label>
		    <input type="text" name="plotblock" class="form-control" maxlength="10" placeholder="Max 10 Charectors">
        ...
        <input type="text" class="form-control" name="plotdemand" id="inlineFormInputGroupUsername2" maxlength="6" placeholder="Max 6 Charectors">

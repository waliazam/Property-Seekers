...
<section id="all-listing" class="desktop-section">
  ...
  <tbody>
    <?php 
      include "dbconnect.php";
      $sql= "SELECT * FROM houses WHERE h_type = 'Commercial Plot' AND size='5'";
      $result = $con->query($sql);

       while($row = $result->fetch_assoc()) {?>
        <tr onclick="window.location='listingdetail.php?details=<?=$row['id']; ?>';"; style="cursor: pointer; ">
      <!-- <th scope="row">Pl-40<?= $row['id']; ?></th> -->
      <td class="logo-col" ><a href="https://wa.me/923335146361?text=Url"><img src="images/icons8-whatsapp-100.png" alt="whatsapp" class="logo-whatsapp"></td>
...
<!--       
  ...
  <tbody>
    <?php 
      include "dbconnect.php";
      $sql= "SELECT * FROM houses WHERE h_type = 'Commercial Plot' AND size='7'";
      $result = $con->query($sql);
...
<!-- 10 Marla -->
  ...
  <tbody>
    <?php 
      include "dbconnect.php";
      $sql= "SELECT * FROM houses WHERE h_type = 'Commercial Plot' AND size='10'";
      $result = $con->query($sql);
...
<!-- 1 Marla Kanal -->
  ...
  <tbody>
    <?php 
      include "dbconnect.php";
      $sql= "SELECT * FROM houses WHERE h_type = 'Commercial Plot' AND size='20'";
      $result = $con->query($sql);
    ...
    <?php 
      ...
      $result = $con->query($sql);
       ...
       while($row = $result->fetch_assoc()) {?>
        <tr onclick="window.location='listingdetail.php?details=<?=$row['id']; ?>';"; style="cursor: pointer; ">
      <!-- <th scope="row">Pl-40<?= $row['id']; ?></th> -->
      <td class="logo-col" ><a  name="wpbtn"><img src="images/icons8-whatsapp-100.png" alt="whatsapp" class="logo-whatsapp"></td>
      <td><?= $row['h_block']; ?></td>
      <td><?= $row['h_number']; ?> </td>
      <td><?= $row['demand']; ?></td>
      <td class="expendtext"><?= truncateString($row['exfeature'], 23, false) ?> <a href="#" class="readmore">Read More</a></td>
  ...
  <tbody>
    <?php 
      ...
      $result = $con->query($sql);
       ...
       while($row = $result->fetch_assoc()) {?>
        <tr onclick="window.location='listingdetail.php?details=<?=$row['id']; ?>';"; style="cursor: pointer; ">
        <td class="logo-col" ><a href="https://wa.me/923335146361?text=<?= $row['h_block']; ?>"><img src="images/icons8-whatsapp-100.png" alt="whatsapp" class="logo-whatsapp"></td>
     <td><?= $row['h_block']; ?></td>
      <td><?= $row['h_number']; ?> </td>
      <!-- <td><?= $row['size']; ?> <span>Marla</span></td> -->
      <td><?= $row['demand']; ?></td>
...
<!-- 1 Marla Kanal -->
  ...
  <thead>
   <tr>
      <!-- <th scope="col">Ref</th> -->
    <th scope="col"  class="whatsappicon">Block</th>
    <th scope="col" width="130px;">Block</th>
      <th scope="col" width="95px;">Plot No</th>
      <th scope="col" width="90px;">Demand</th>
      <th scope="col">Details</th>

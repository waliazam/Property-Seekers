...
<!-- <section id="all-listing">
  ...
  <tbody>
    <?php 
      include "dbconnect.php";
      $sql= "SELECT * FROM houses WHERE h_type = 'House'";
          ...
          <div class="row">
            <?php   include "dbconnect.php";
              ...
              <div class="col-md-4">
                ...
                <a href="listingdetail.php?details=<?=$row['id']; ?>"><img src="<?= $row['h_images'];?>" alt="<?= $row['h_type'];?>" class="img-fluid" alt="Responsive image"></a>
                </div>
              </div>

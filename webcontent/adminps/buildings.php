  ...
  <div class="container">
  	<div class="col-md-12">
  		<form class="house-form">
		    ...
		    <input type="text" id="disabledInput" class="form-control" placeholder="Building" disabled>
		    <br>
		    ...
		    <div class="form-row">
		    	<div class="col-md-4">
				    <input type="checkbox" name="Servent_room">
		    	...
		    	<div class="col-md-4">
				    ...
				    <label for="inputState">Laundry</label>
		    ...
		    <div class="form-row">
		    	...
		    	<div class="col-md-4">
				    <input type="checkbox" name="powder_room">
		    ...
		    <div class="form-row">
		    	...
		    	<div class="col-md-4">
				    <input type="checkbox" name="has_lawn">
				    <label for="inputState">Has Lawn</label>
		    		
		    	</div>
		    	<div class="col-md-4">
				    <input type="checkbox" name="street_dead_end">

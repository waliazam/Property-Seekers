...
<html lang="en">
  <head>
    ...
    <title>Property Seekers | Home</title>
    
    <!-- Favicon -->
    <link rel="shortcut icon" href="img/favicon.ico" type="image/x-icon">

    <!-- Font awesome -->
    <link href="webcontent/css/font-awesome.css" rel="stylesheet">
    <!-- Bootstrap -->
    <link href="webcontent/css/bootstrap.css" rel="stylesheet">   
    <!-- slick slider -->
    <link rel="stylesheet" type="text/css" href="webcontent/css/slick.css">
    <!-- price picker slider -->
    <link rel="stylesheet" type="text/css" href="webcontent/css/nouislider.css">
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="webcontent/css/jquery.fancybox.css" type="text/css" media="screen" /> 
    <!-- Theme color -->
    <link id="switcher" href="webcontent/css/theme-color/default-theme.css" rel="stylesheet">     
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,700&display=swap" rel="stylesheet">
  ...
  <!-- END SCROLL TOP BUTTON -->
    ...
    <?php
  include 'webcontent/property_catagories/header.php'
    ?>
  <!-- Start slider  -->
    ...
    <div class="aa-slider-area"> 
      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 2.jpg" alt="img">
          <!-- Top slider content -->
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 3.jpg" alt="img">
          <!-- Top slider content -->
         <!--  <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 4.jpg" alt="img">
          <!-- Top slider content -->
          <!-- <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->       
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 5.jpg" alt="img">
          <!-- Top slider content -->
         <!--  <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->        
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 6.jpg" alt="img">
          <!-- Top slider content -->
         <!--  <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
        ...
        <!-- / Top slider single slide -->
         <!-- Top slider single slide -->
        <div class="aa-top-slider-single">
          <img src="webcontent/img/slider/image 7.jpg" alt="img">
          <!-- Top slider content -->
          <!-- <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Duplex</span>
            <h2 class="aa-top-slider-title">1560 Square Feet</h2>
 ...
 <!--  <section id="aa-advance-search">
  ...
  <!-- / About us -->
<!-- Propery Summery start -->
<?php
include "webcontent/adminps/dbconnect.php";
      ...
      <div class="col-md-12">
        <div class="aa-service-area">
          ...
          <div class="aa-service-content">
            <div class="row">
              <div class="col-md-3">
                <a href="webcontent/adminps/housesdetails.php">
                  <div class="aa-single-service">
                    <div class="aa-service-icon">
                      <span class="fa fa-home"></span>
                    </div>
                    <div class="aa-single-service-content">
                      <h4><a href="webcontent/adminps/housesdetails.php">Houses</a></h4>
                      <h2><?= $houses ?></h2>
                    </div>
                  </div>
                </a>
              ...
              <div class="col-md-3">
                <a href="webcontent/adminps/plotdetails.php">
                  <div class="aa-single-service">
                    <div class="aa-service-icon">
                      <span class="fa fa-anchor"></span>
                    </div>
                    <div class="aa-single-service-content">
                      <h4><a href="webcontent/adminps/plotdetails.php">Plots</a></h4>
                      <h2><?= $plots ?></h2>
                    </div>
                  </div>
                </a>
              ...
              <div class="col-md-3">
                <a href="webcontent/adminps/commercial_plots.php">
                <div class="aa-single-service">
                  <div class="aa-service-icon">
                    <span class="fa fa-crop"></span>
                  </div>
                  <div class="aa-single-service-content">
                    <h4><a href="webcontent/adminps/commertial_plots.php">Commercial Plots</a></h4>
                    <h2><?= $cplots ?></h2>
                  </div>
                </div>
                </a>
          ...
          <div class="row">
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="properties-detail.php" class="aa-properties-item-img">
                  <img src="webcontent/img/item/item1.jpg" alt="img">
                </a>
                ...
                <div class="aa-properties-item-content">
                  ...
                  <div class="aa-properties-detial">
                    ...
                    <a href="properties-detail.php" class="aa-secondary-btn">View Details</a>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="webcontent/img/item/item2.jpg" alt="img">
                </a>
            ...
            <div class="col-md-4">
              <article class="aa-properties-item">
                <a href="#" class="aa-properties-item-img">
                  <img src="webcontent/img/item/item3.jpg" alt="img">
                </a>
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="aa-footer-left">
               <p>Designed by <a rel="nofollow" href="http://www.markups.io/">Wali Azam</a></p>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
...
@media (max-width: 767px){
  ...
  <!-- slick slider -->
  <script type="text/javascript" src="webcontent/js/slick.js"></script>
  <!-- Price picker slider -->
  <script type="text/javascript" src="webcontent/js/nouislider.js"></script>
   <!-- mixit slider -->
  <script type="text/javascript" src="webcontent/js/jquery.mixitup.js"></script>
  <!-- Add fancyBox -->        
  <script type="text/javascript" src="webcontent/js/jquery.fancybox.pack.js"></script>
  <!-- Custom js -->
